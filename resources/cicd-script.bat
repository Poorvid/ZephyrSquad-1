...
set "$accessKey=MTJmYWExNzItNTQyNy0zYjg3LWJiZTItNzU3NzgzMzBmOWZjIDVlZWIzNzE2NDc4NDUxMGFjYTc2Y2E2MSBVU0VSX0RFRkFVTFRfTkFNRQ"
set "$secretKey=bY9JcanPv_H6pIn06X-70oC_V027kn5u83WZwh4yKgA"
:: Id of the user who will create the automation task. You can find it in Jira.
set "$accountId=557058:5eeb37164784510aca76ca61"
...
set "$resultPath=@\"C:\Windows\System32\config\systemprofile\AppData\Local\Jenkins\.jenkins\workspace\Zephyr-Jenkins\target\surefire-reports\testng-results.xml"
